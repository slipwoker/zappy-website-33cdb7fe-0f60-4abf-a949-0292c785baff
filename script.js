    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לק פרפקט אקדמי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '33cdb7fe-0f60-4abf-a949-0292c785baff',
                    name: data.name || '',
                    email: data.email || '',
